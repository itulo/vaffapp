...
The app gathers insults from different italian dialects, grouped by region, with an interpretation in standard italian. All the insults are stored in an SQlite database, which I update from time to time.
...
* InsultListActivity: InsultDetailActivity, InsultDetailFragment and InsultListFragment are part of this activity too. Here the user can look at all insults in a list. This activity is hidden in the beginning and it can be unlocked by buying it.
