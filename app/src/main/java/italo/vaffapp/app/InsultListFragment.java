 ...
 * currently being viewed in a {@link InsultDetailFragment}.
 * <p/>
 * Activities containing this fragment MUST implement the {@link Callbacks}
 * interface.
 */
public class InsultListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(Integer.toString(InsultContent.ITEMS.get(position).getId()));
    }
